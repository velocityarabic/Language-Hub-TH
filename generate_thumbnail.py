...
SCENIC_STYLES = [
    "stunning Thai woman in traditional Thai silk dress, Grand Palace Bangkok, golden spires, sunny day",
    "elegant Thai woman in traditional costume, Wat Phra Kaew, emerald Buddha temple, morning light",
    "beautiful Thai woman in modern attire, Wat Arun temple, Chao Phraya river, sunset glow",
    "Thai girl at white sand beach, Phi Phi islands, crystal clear water, turquoise sea",
    "gorgeous Thai woman in traditional Thai dress, ancient Ayutthaya temple ruins, golden hour",
    "beautiful Thai woman with elephants, Chiang Mai mountain sanctuary, soft morning light",
    "Thai woman in traditional silk, floating market, colorful longtail boats, vibrant atmosphere",
    "elegant Thai woman, Wat Pho reclining Buddha, serene temple garden, peaceful blue hour",
]


def generate_scenic_image(category_english: str, category_thai: str, output_path: str):
    if POLLINATIONS_API_KEY:
        for attempt in range(3):
            style = random.choice(SCENIC_STYLES)
            prompt = (
                f"Professional YouTube thumbnail for Thai language learning video. "
                f"{style}. "
                ...
                f"At top: '120 THAI PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY THAI'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    draw.text((960, 180), "120 THAI PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
