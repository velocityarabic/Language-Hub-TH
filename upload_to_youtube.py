"""
YouTube Upload Script for Velocity Thai
"""
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Thai with Velocity Thai"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Thai", "Thai Phrases", "Thai Language", "Velocity Thai", "Thai for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY THAI - YOUTUBE UPLOADER")
